...
static bool isInit;
static uint8_t disableFusion = 0;
...
/**
 * @brief If non-zero, prevents the Z-ranger from sending data to the Kalman filter (sensor fusion)
 */
PARAM_ADD(PARAM_UINT8, disableZRanger, &disableFusion) 
